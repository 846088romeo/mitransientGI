...
* `ghost-imaging`: Examples for ghost imaging simulations. We show how to simulate a ghost imaging setup, and how to reconstruct the non-visible object from the entangled photons.
